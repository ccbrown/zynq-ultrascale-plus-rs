...
/// APU 2 Performance Monitor Unit profiler, A53 Performance Monitor Unit profiler
pub static mut CORESIGHT_A53_PMU_2: *mut Registers = 0xfee30000 as *mut Registers;
register_structs! {
    pub Registers {
