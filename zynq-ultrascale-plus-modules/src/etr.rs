...
pub struct Registers {
    _padding0: [u8; 4],
    /// RAM size Register
    pub rsz: ReadWrite<u32, Rsz::Register>,
    _padding8: [u8; 4],
    /// TMC Status register
    ...
    pub rrphi: ReadWrite<u32, Rrphi::Register>,
    ...
    pub rwphi: ReadWrite<u32, Rwphi::Register>,
    _padding64: [u8; 208],
    ...
    pub axictl: ReadWrite<u32, Axictl::Register>,
    _padding276: [u8; 4],
    ...
    pub dbahi: ReadWrite<u32, Dbahi::Register>,
    _padding288: [u8; 480],
