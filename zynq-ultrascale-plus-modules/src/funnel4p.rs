...
/// Four-Port CoreSight Funnel, Funnel for multiple trace streams to single ATB
pub static mut CORESIGHT_SOC_FUNN_1: *mut Registers = 0xfe920000 as *mut Registers;
/// Four-Port CoreSight Funnel, Funnel for multiple trace streams to single ATB
pub static mut CORESIGHT_SOC_FUNN_2: *mut Registers = 0xfe930000 as *mut Registers;
register_structs! {
    pub Registers {
        /// The Funnel Control Register enables the slave ports and defines the hold time of the slave ports. Hold time refers to the number of transactions that are output on the funnel master port from the same slave while that slave port atvalidsx is HIGH. Hold time does not refer to clock cycles in this context
        (0x00000000 => pub ctrl_reg: ReadWrite<u32, CtrlReg::Register>),
        ...
        (0x00000004 => pub priority_ctrl_reg: ReadWrite<u32, PriorityCtrlReg::Register>),
        ...
        (0x00000eec => pub itatbdata0: ReadWrite<u32, Itatbdata0::Register>),
        ...
        (0x00000ef0 => pub itatbctr2: ReadWrite<u32, Itatbctr2::Register>),
        ...
        (0x00000ef4 => pub itatbctr1: ReadWrite<u32, Itatbctr1::Register>),
        ...
        (0x00000ef8 => pub itatbctr0: ReadWrite<u32, Itatbctr0::Register>),
