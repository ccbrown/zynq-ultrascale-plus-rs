...
pub struct Registers {
    ...
    pub supported_port_sizes: ReadOnly<u32, SupportedPortSizes::Register>,
    ...
    pub current_port_size: ReadWrite<u32, CurrentPortSize::Register>,
    _padding8: [u8; 248],
    /// This register indicates the implemented Trigger Counter multipliers and other supported features of the trigger system.
    pub supported_trigger_modes: ReadOnly<u32, SupportedTriggerModes::Register>,
    ...
    pub trigger_counter_value: ReadWrite<u32, TriggerCounterValue::Register>,
    ...
    pub trigger_multiplier: ReadWrite<u32, TriggerMultiplier::Register>,
    _padding268: [u8; 244],
    ...
    pub supported_test_pattern_modes: ReadOnly<u32, SupportedTestPatternModes::Register>,
    ...
    pub current_test_pattern_mode: ReadWrite<u32, CurrentTestPatternMode::Register>,
    ...
    pub tprcr: ReadWrite<u32, Tprcr::Register>,
    _padding524: [u8; 244],
    ...
    pub fscr: ReadWrite<u32, Fscr::Register>,
    _padding780: [u8; 244],
    ...
    pub extctl_in_port: ReadOnly<u32, ExtctlInPort::Register>,
    /// Two ports can be used as a control and feedback mechanism for any serializers, pin sharing multiplexors or other solutions that might be added to the trace output pins either for pin control or a high speed trace port solution. These ports are raw register banks that sample or export the corresponding external pins. The output register bank is set to all zeros on reset. The input registers sample the incoming signals and as such are undefined.
    pub extctl_out_port: ReadWrite<u32, ExtctlOutPort::Register>,
    _padding1032: [u8; 2780],
    ...
    pub ittrflinack: WriteOnly<u32, Ittrflinack::Register>,
