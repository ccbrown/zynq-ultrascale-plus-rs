...
/// 8K Embedded Trace FIFO, Embedded Trace FIFO
pub static mut CORESIGHT_SOC_ETF_2: *mut Registers = 0xfe950000 as *mut Registers;
register_structs! {
    pub Registers {
        (0x00000000 => _padding0),
        /// RAM size Register
        (0x00000004 => pub rsz: ReadOnly<u32>),
...
register_bitfields! [
    u32,
    pub Rrp [
        RRP OFFSET(0) NUMBITS(13) [],
    ]
];
register_bitfields! [
    u32,
    pub Rwp [
        RWP OFFSET(0) NUMBITS(13) [],
    ]
];
register_bitfields! [
    u32,
    pub Trg [
        TRG OFFSET(0) NUMBITS(11) [],
    ]
];
register_bitfields! [
    u32,
...
register_bitfields! [
    u32,
    pub Lbuflevel [
        LBUFLEVEL OFFSET(0) NUMBITS(12) [],
    ]
];
register_bitfields! [
    u32,
    pub Cbuflevel [
        CBUFLEVEL OFFSET(0) NUMBITS(12) [],
    ]
];
register_bitfields! [
    u32,
    pub Bufwm [
        BUFWM OFFSET(0) NUMBITS(11) [],
    ]
];
register_bitfields! [
    u32,
