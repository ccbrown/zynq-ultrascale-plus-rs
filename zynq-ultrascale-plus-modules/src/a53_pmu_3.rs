...
/// APU 3 Performance Monitor Unit profiler, A53 Performance Monitor Unit profiler
pub static mut CORESIGHT_A53_PMU_3: *mut Registers = 0xfef30000 as *mut Registers;
#[repr(C)]
