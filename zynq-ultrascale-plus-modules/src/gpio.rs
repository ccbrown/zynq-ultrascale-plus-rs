...
register_structs! {
    pub Registers {
        ...
        (0x00000000 => pub mask_data_0_lsw: Aliased<u32, MaskData0LswR::Register, MaskData0LswW::Register>),
        /// Maskable Output Data (GPIO Bank0, MIO, Upper 10bits)
        (0x00000004 => pub mask_data_0_msw: Aliased<u32, MaskData0MswR::Register, MaskData0MswW::Register>),
        /// Maskable Output Data (GPIO Bank1, MIO, Lower 16bits)
        (0x00000008 => pub mask_data_1_lsw: Aliased<u32, MaskData1LswR::Register, MaskData1LswW::Register>),
        /// Maskable Output Data (GPIO Bank1, MIO, Upper 10 bits)
        (0x0000000c => pub mask_data_1_msw: Aliased<u32, MaskData1MswR::Register, MaskData1MswW::Register>),
        /// Maskable Output Data (GPIO Bank2, MIO, Lower 16 bits)
        (0x00000010 => pub mask_data_2_lsw: Aliased<u32, MaskData2LswR::Register, MaskData2LswW::Register>),
        /// Maskable Output Data (GPIO Bank2, MIO, Upper 10 bits)
        (0x00000014 => pub mask_data_2_msw: Aliased<u32, MaskData2MswR::Register, MaskData2MswW::Register>),
        /// Maskable Output Data (GPIO Bank3, EMIO, Lower 16bits)
        (0x00000018 => pub mask_data_3_lsw: Aliased<u32, MaskData3LswR::Register, MaskData3LswW::Register>),
        /// Maskable Output Data (GPIO Bank3, EMIO, Upper 16bits)
        (0x0000001c => pub mask_data_3_msw: Aliased<u32, MaskData3MswR::Register, MaskData3MswW::Register>),
        /// Maskable Output Data (GPIO Bank4, EMIO, Lower 16bits)
        (0x00000020 => pub mask_data_4_lsw: Aliased<u32, MaskData4LswR::Register, MaskData4LswW::Register>),
        /// Maskable Output Data (GPIO Bank4, EMIO, Upper 16bits)
        (0x00000024 => pub mask_data_4_msw: Aliased<u32, MaskData4MswR::Register, MaskData4MswW::Register>),
        /// Maskable Output Data (GPIO Bank5, EMIO, Lower 16bits)
        (0x00000028 => pub mask_data_5_lsw: Aliased<u32, MaskData5LswR::Register, MaskData5LswW::Register>),
        /// Maskable Output Data (GPIO Bank5, EMIO, Upper 16bits)
        (0x0000002c => pub mask_data_5_msw: Aliased<u32, MaskData5MswR::Register, MaskData5MswW::Register>),
        (0x00000030 => _padding48),
        /// Output Data (GPIO Bank0, MIO)
        (0x00000040 => pub data_0: Aliased<u32, Data0R::Register, Data0W::Register>),
        /// Output Data (GPIO Bank1, MIO)
        (0x00000044 => pub data_1: Aliased<u32, Data1R::Register, Data1W::Register>),
        /// Output Data (GPIO Bank2, MIO)
        (0x00000048 => pub data_2: Aliased<u32, Data2R::Register, Data2W::Register>),
        /// Output Data (GPIO Bank3, EMIO)
        (0x0000004c => pub data_3: ReadWrite<u32>),
        /// Output Data (GPIO Bank4, EMIO)
        (0x00000050 => pub data_4: ReadWrite<u32>),
        /// Output Data (GPIO Bank5, EMIO)
        (0x00000054 => pub data_5: ReadWrite<u32>),
        (0x00000058 => _padding88),
        /// Input Data (GPIO Bank0, MIO)
        (0x00000060 => pub data_0_ro: ReadOnly<u32, Data0Ro::Register>),
        /// Input Data (GPIO Bank1, MIO)
        (0x00000064 => pub data_1_ro: ReadOnly<u32, Data1Ro::Register>),
        /// Input Data (GPIO Bank2, MIO)
        (0x00000068 => pub data_2_ro: ReadOnly<u32, Data2Ro::Register>),
        /// Input Data (GPIO Bank3, EMIO)
        (0x0000006c => pub data_3_ro: ReadOnly<u32>),
        /// Input Data (GPIO Bank4, EMIO)
        (0x00000070 => pub data_4_ro: ReadOnly<u32>),
        /// Input Data (GPIO Bank5, EMIO)
        (0x00000074 => pub data_5_ro: ReadOnly<u32>),
        (0x00000078 => _padding120),
        /// Direction mode (GPIO Bank0, MIO)
        (0x00000204 => pub dirm_0: Aliased<u32, Dirm0R::Register, Dirm0W::Register>),
        /// Output enable (GPIO Bank0, MIO)
        (0x00000208 => pub oen_0: Aliased<u32, Oen0R::Register, Oen0W::Register>),
        /// Interrupt Mask Status (GPIO Bank0, MIO)
        (0x0000020c => pub int_mask_0: ReadOnly<u32, IntMask0::Register>),
        /// Interrupt Enable/Unmask (GPIO Bank0, MIO)
        (0x00000210 => pub int_en_0: Aliased<u32, IntEn0R::Register, IntEn0W::Register>),
        /// Interrupt Disable/Mask (GPIO Bank0, MIO)
        (0x00000214 => pub int_dis_0: Aliased<u32, IntDis0R::Register, IntDis0W::Register>),
        /// Interrupt Status (GPIO Bank0, MIO)
        (0x00000218 => pub int_stat_0: Aliased<u32, IntStat0R::Register, IntStat0W::Register>),
        /// Interrupt Type (GPIO Bank0, MIO)
        (0x0000021c => pub int_type_0: Aliased<u32, IntType0R::Register, IntType0W::Register>),
        /// Interrupt Polarity (GPIO Bank0, MIO)
        (0x00000220 => pub int_polarity_0: Aliased<u32, IntPolarity0R::Register, IntPolarity0W::Register>),
        /// Interrupt Any Edge Sensitive (GPIO Bank0, MIO)
        (0x00000224 => pub int_any_0: Aliased<u32, IntAny0R::Register, IntAny0W::Register>),
        (0x00000228 => _padding552),
        /// Direction mode (GPIO Bank1, MIO)
        (0x00000244 => pub dirm_1: Aliased<u32, Dirm1R::Register, Dirm1W::Register>),
        /// Output enable (GPIO Bank1, MIO)
        (0x00000248 => pub oen_1: Aliased<u32, Oen1R::Register, Oen1W::Register>),
        /// Interrupt Mask Status (GPIO Bank1, MIO)
        (0x0000024c => pub int_mask_1: ReadOnly<u32, IntMask1::Register>),
        /// Interrupt Enable/Unmask (GPIO Bank1, MIO)
        (0x00000250 => pub int_en_1: Aliased<u32, IntEn1R::Register, IntEn1W::Register>),
        /// Interrupt Disable/Mask (GPIO Bank1, MIO)
        (0x00000254 => pub int_dis_1: Aliased<u32, IntDis1R::Register, IntDis1W::Register>),
        /// Interrupt Status (GPIO Bank1, MIO)
        (0x00000258 => pub int_stat_1: Aliased<u32, IntStat1R::Register, IntStat1W::Register>),
        /// Interrupt Type (GPIO Bank1, MIO)
        (0x0000025c => pub int_type_1: Aliased<u32, IntType1R::Register, IntType1W::Register>),
        /// Interrupt Polarity (GPIO Bank1, MIO)
        (0x00000260 => pub int_polarity_1: Aliased<u32, IntPolarity1R::Register, IntPolarity1W::Register>),
        /// Interrupt Any Edge Sensitive (GPIO Bank1, MIO)
        (0x00000264 => pub int_any_1: Aliased<u32, IntAny1R::Register, IntAny1W::Register>),
        (0x00000268 => _padding616),
        /// Direction mode (GPIO Bank2, MIO)
        (0x00000284 => pub dirm_2: Aliased<u32, Dirm2R::Register, Dirm2W::Register>),
        /// Output enable (GPIO Bank2, MIO)
        (0x00000288 => pub oen_2: Aliased<u32, Oen2R::Register, Oen2W::Register>),
        /// Interrupt Mask Status (GPIO Bank2, MIO)
        (0x0000028c => pub int_mask_2: ReadOnly<u32, IntMask2::Register>),
        /// Interrupt Enable/Unmask (GPIO Bank2, MIO)
        (0x00000290 => pub int_en_2: Aliased<u32, IntEn2R::Register, IntEn2W::Register>),
        /// Interrupt Disable/Mask (GPIO Bank2, MIO)
        (0x00000294 => pub int_dis_2: Aliased<u32, IntDis2R::Register, IntDis2W::Register>),
        /// Interrupt Status (GPIO Bank2, MIO)
        (0x00000298 => pub int_stat_2: Aliased<u32, IntStat2R::Register, IntStat2W::Register>),
        /// Interrupt Type (GPIO Bank2, MIO)
        (0x0000029c => pub int_type_2: Aliased<u32, IntType2R::Register, IntType2W::Register>),
        /// Interrupt Polarity (GPIO Bank2, MIO)
        (0x000002a0 => pub int_polarity_2: Aliased<u32, IntPolarity2R::Register, IntPolarity2W::Register>),
        /// Interrupt Any Edge Sensitive (GPIO Bank2, MIO)
        (0x000002a4 => pub int_any_2: Aliased<u32, IntAny2R::Register, IntAny2W::Register>),
        (0x000002a8 => _padding680),
        /// Direction mode (GPIO Bank3, EMIO Bank0)
        (0x000002c4 => pub dirm_3: ReadWrite<u32>),
        /// Output enable (GPIO Bank3, EMIO Bank0)
        (0x000002c8 => pub oen_3: ReadWrite<u32>),
        /// Interrupt Mask Status (GPIO Bank3, EMIO Bank0)
        (0x000002cc => pub int_mask_3: ReadOnly<u32>),
        /// Interrupt Enable/Unmask (GPIO Bank3, EMIO Bank0)
        (0x000002d0 => pub int_en_3: WriteOnly<u32>),
        /// Interrupt Disable/Mask (GPIO Bank3, EMIO Bank0)
        (0x000002d4 => pub int_dis_3: WriteOnly<u32>),
        /// Interrupt Status (GPIO Bank3, EMIO Bank0)
        (0x000002d8 => pub int_stat_3: ReadWrite<u32>),
        /// Interrupt Type (GPIO Bank3, EMIO Bank0)
        (0x000002dc => pub int_type_3: ReadWrite<u32>),
        /// Interrupt Polarity (GPIO Bank3, EMIO Bank0)
        (0x000002e0 => pub int_polarity_3: ReadWrite<u32>),
        /// Interrupt Any Edge Sensitive (GPIO Bank3, EMIO Bank0)
        (0x000002e4 => pub int_any_3: ReadWrite<u32>),
        (0x000002e8 => _padding744),
        /// Direction mode (GPIO Bank4, EMIO Bank1)
        (0x00000304 => pub dirm_4: ReadWrite<u32>),
        /// Output enable (GPIO Bank4, EMIO Bank1)
        (0x00000308 => pub oen_4: ReadWrite<u32>),
        /// Interrupt Mask Status (GPIO Bank4, EMIO Bank1)
        (0x0000030c => pub int_mask_4: ReadOnly<u32>),
        /// Interrupt Enable/Unmask (GPIO Bank4, EMIO Bank1)
        (0x00000310 => pub int_en_4: WriteOnly<u32>),
        /// Interrupt Disable/Mask (GPIO Bank4, EMIO Bank1)
        (0x00000314 => pub int_dis_4: WriteOnly<u32>),
        /// Interrupt Status (GPIO Bank4, EMIO Bank1)
        (0x00000318 => pub int_stat_4: ReadWrite<u32>),
        /// Interrupt Type (GPIO Bank4, EMIO Bank1)
        (0x0000031c => pub int_type_4: ReadWrite<u32>),
        /// Interrupt Polarity (GPIO Bank4, EMIO Bank1)
        (0x00000320 => pub int_polarity_4: ReadWrite<u32>),
        /// Interrupt Any Edge Sensitive (GPIO Bank4, EMIO Bank1)
        (0x00000324 => pub int_any_4: ReadWrite<u32>),
        (0x00000328 => _padding808),
        /// Direction mode (GPIO Bank5, EMIO Bank2)
        (0x00000344 => pub dirm_5: ReadWrite<u32>),
        /// Output enable (GPIO Bank5, EMIO Bank2)
        (0x00000348 => pub oen_5: ReadWrite<u32>),
        /// Interrupt Mask Status (GPIO Bank5, EMIO Bank2)
        (0x0000034c => pub int_mask_5: ReadOnly<u32>),
        /// Interrupt Enable/Unmask (GPIO Bank5, EMIO Bank2)
        (0x00000350 => pub int_en_5: WriteOnly<u32>),
        /// Interrupt Disable/Mask (GPIO Bank5, EMIO Bank2)
        (0x00000354 => pub int_dis_5: WriteOnly<u32>),
        /// Interrupt Status (GPIO Bank5, EMIO Bank2)
        (0x00000358 => pub int_stat_5: ReadWrite<u32>),
        /// Interrupt Type (GPIO Bank5, EMIO Bank2)
        (0x0000035c => pub int_type_5: ReadWrite<u32>),
        /// Interrupt Polarity (GPIO Bank5, EMIO Bank2)
        (0x00000360 => pub int_polarity_5: ReadWrite<u32>),
        /// Interrupt Any Edge Sensitive (GPIO Bank5, EMIO Bank2)
        (0x00000364 => pub int_any_5: ReadWrite<u32>),
        (0x00000368 => @END),
    }
}
register_bitfields! [
