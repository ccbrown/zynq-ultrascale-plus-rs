...
pub struct Registers {
    ...
    pub port_type: Aliased<u32, PortTypeR::Register, PortTypeW::Register>,
    /// Set Port Type Register
    pub qos_ctrl: Aliased<u32, QosCtrlR::Register, QosCtrlW::Register>,
    /// Set Value for Read HPR (High Priority Read) CAM Threshold
    pub rd_hpr_thrsld: Aliased<u32, RdHprThrsldR::Register, RdHprThrsldW::Register>,
    /// Set Value for Read LPR (Low Priority Read) CAM Threshold
    pub rd_lpr_thrsld: Aliased<u32, RdLprThrsldR::Register, RdLprThrsldW::Register>,
    /// Set Value for Write CAM Threshold
    pub wr_thrsld: Aliased<u32, WrThrsldR::Register, WrThrsldW::Register>,
    /// ZQCS Control Register 0
    pub zqcs_ctrl0: Aliased<u32, ZqcsCtrl0R::Register, ZqcsCtrl0W::Register>,
    /// ZQCS Control Register 2
    pub zqcs_ctrl1: Aliased<u32, ZqcsCtrl1R::Register, ZqcsCtrl1W::Register>,
    /// ZQCS Status Register
    pub zqcs_status: ReadOnly<u32, ZqcsStatus::Register>,
    /// DDRC External Refresh Control Register
    pub ddrc_ext_refresh: Aliased<u32, DdrcExtRefreshR::Register, DdrcExtRefreshW::Register>,
    _padding36: [u8; 476],
    ...
    pub qos_irq_status: Aliased<u32, QosIrqStatusR::Register, QosIrqStatusW::Register>,
    ...
    pub qos_irq_mask: ReadOnly<u32, QosIrqMask::Register>,
    /// Interrupt Enable Register. A write of to this location will unmask the interrupt. (IMR: 0)
    pub qos_irq_enable: Aliased<u32, QosIrqEnableR::Register, QosIrqEnableW::Register>,
    /// Interrupt Disable Register. A write of one to this location will mask the interrupt. (IMR: 1)
    pub qos_irq_disable: Aliased<u32, QosIrqDisableR::Register, QosIrqDisableW::Register>,
    _padding528: [u8; 768],
    /// DDRC URGENT Sideband signal control register
    pub ddrc_urgent: Aliased<u32, DdrcUrgentR::Register, DdrcUrgentW::Register>,
    /// DDRC QVN Control register
    pub ddrc_qvn_ctrl: Aliased<u32, DdrcQvnCtrlR::Register, DdrcQvnCtrlW::Register>,
    /// DDRC MRR Register Status
    pub ddrc_mrr_status: ReadOnly<u32, DdrcMrrStatus::Register>,
    /// DDRC MRR Register Data
    pub ddrc_mrr_data0: ReadOnly<u32>,
    /// DDRC MRR Register Data
    pub ddrc_mrr_data1: ReadOnly<u32>,
    /// DDRC MRR Register Data
    pub ddrc_mrr_data2: ReadOnly<u32, DdrcMrrData2::Register>,
    /// DDRC MRR Register Data
    pub ddrc_mrr_data3: ReadOnly<u32>,
    /// DDRC MRR Register Data
    pub ddrc_mrr_data4: ReadOnly<u32>,
    /// DDRC MRR Register Data
    pub ddrc_mrr_data5: ReadOnly<u32, DdrcMrrData5::Register>,
    /// DDRC MRR Register Data
    pub ddrc_mrr_data6: ReadOnly<u32>,
    /// DDRC MRR Register Data
    pub ddrc_mrr_data7: ReadOnly<u32>,
    /// DDRC MRR Register Data
    pub ddrc_mrr_data8: ReadOnly<u32, DdrcMrrData8::Register>,
    /// DDRC MRR Register Data
    pub ddrc_mrr_data9: ReadOnly<u32>,
    /// DDRC MRR Register Data
    pub ddrc_mrr_data10: ReadOnly<u32>,
    /// DDRC MRR Register Data
    pub ddrc_mrr_data11: ReadOnly<u32, DdrcMrrData11::Register>,
    _padding1356: [u8; 436],
    /// DDR Sub system clock control
    pub ddr_clk_ctrl: Aliased<u32, DdrClkCtrlR::Register, DdrClkCtrlW::Register>,
}
